<?php class GPUR_Elementor_Good_Points_Widget extends Elementor\Widget_Base {

	public function get_name() {
		return 'gpur_good_points';
	}

	public function get_title() {
		return esc_html__( 'Good Points', 'gpur' );
	}
	...
	protected function render() {
		...
		// Load template
		echo gpur_good_points_template( array( 'builder' => 'elementor', 'atts' => $atts ) );
